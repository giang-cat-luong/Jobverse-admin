    ...
    <div className="min-h-screen bg-[#F8F9FB] flex">
      ...
      <div className="flex-1">
        ...
        <div className="p-0 md:p-8">
          <div className="rounded-lg p-0 md:p-6 pt-[4.5rem] md:pt-0">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          Tạo các dịch vụ hấp dẫn để thu hút người thuê và tạo
                          ra thu nhập trên fastlance
                        </p>
                      </div>
                    </div>
                    <Link
                  ...
                  <div className="flex flex-col gap-2 md:flex-row md:gap-0 items-center justify-between p-4 border border-gray-200 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          Thêm kinh nghiệm làm việc, trình độ học vấn và các kỹ
                          năng của bạn
                        </p>
                      </div>
                    </div>
